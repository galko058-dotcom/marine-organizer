...
>
        <table
          style={{
            minWidth: "800px", // 🔥 важно за mobile
            width: "100%",
            marginTop: 12,
...
>
            <tr>
              <th style={{ width: "25%", padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>
                Job
              </th>
              <th style={{ width: "20%", padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>
                WO
              </th>
              <th style={{ width: "15%", padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>
                Contact
              </th>
              <th style={{ width: "10%", padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>
                SE
              </th>
              <th style={{ width: "10%", padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>
                Status
            ...
            {ongoingTasks.map(task => (
              ...
              >
                <td style={{padding: "12px 14px" }}>
                  <AutoTextarea
                    value={task.job}
                    onBlur={e => updateTask(task.id, { job: e.target.value })}
                  />
                </td>
                ...
                <td style={{ padding: "12px 14px" }}>
                  <AutoTextarea
                    ...
                    onBlur={e => updateTask(task.id, { workOrder: e.target.value })}
                  />
                </td>
                ...
                <td style={{padding: "12px 14px" }}>
                  <AutoTextarea
                    value={task.contact}
                    onBlur={e => updateTask(task.id, { contact: e.target.value })}
                  />
                </td>
                ...
                <td style={{ padding: "12px 14px" }}>
                  <select
                    ...
                    onChange={e => updateTask(task.id, { seInCharge: e.target.value })}
                  >
                    {users.map(u => (
                ...
                <td style={{padding: "12px 14px" }}>{task.status}</td>
...
>
            <tr>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>Job</th>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>WO</th>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>Expected</th>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>SE</th>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>Progress & Files</th>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>Delete</th>
            </tr>
          </thead>
          ...
          <tbody>
            {upcomingTasks.map(task => (
              <tr
                key={task.id}
                style={{ borderTop: "1px solid #1e293b", transition: "0.2s" }}
                onMouseEnter={e => (e.currentTarget.style.background = "#0f172a")}
                onMouseLeave={e => (e.currentTarget.style.background = "transparent")}
              >
                <td style={{ padding: "12px 14px" }}>
                ...
                <td style={{ padding: "12px 14px" }}>
                  <AutoTextarea
                    ...
                    onBlur={e => updateTask(task.id, { expectedAt: e.target.value })}
                  />
                </td>
                ...
                <td style={{ padding: "12px 14px" }}>
                  <button onClick={() => setSelectedTaskId(task.id)}>Open</button>
                </td>
...
>
            <tr>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>Job</th>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>WO</th>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>Archived at</th>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>Restore</th>
              <th style={{ padding: "12px 14px", textAlign: "left", color: "#38bdf8" }}>Delete</th>
            </tr>
          </thead>
          ...
          <tbody>
            {archivedTasks.map(task => (
              ...
              >
                <td style={{ padding: "12px 14px" }}>{task.job}</td>
                <td style={{ padding: "12px 14px" }}>{task.workOrder}</td>
                <td style={{ padding: "12px 14px" }}>{task.archivedAt}</td>
...
<div
  style={{
    ...
    backgroundAttachment: "fixed", // 🔥 КЛЮЧОВО
    backgroundRepeat: "no-repeat",
    backgroundSize: "cover", // 🔥 КЛЮЧОВО
    color: "#e2e8f0",
    display: "flex",
...
>
  ...
  >
    <button onClick={() => setView("duty")}>Duty</button>
